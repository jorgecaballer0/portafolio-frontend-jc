    ...
    <>
      <section id="home" className="h-screen pt-16 overflow-hidden">
        <div className="container relative h-full mx-auto text-center">
          ...
          <Links />
          <HomeSocial />
          <div className="bg-gradient-to-b from-primary-main to-background-bgColor dark:to-slate-300 w-72 h-[25rem] absolute left-[calc(50%_-_9rem)] mt-24 rounded-t-full overflow-hidden py-7">
