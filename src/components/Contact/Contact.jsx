...
const Contact = () => {
  return (
    <section id="contacto" className="container mx-auto text-center p-28 sm:p-[4.5rem]">
      ...
      <div className="grid w-4/5 grid-cols-2 pt-10 mx-auto sm:grid-cols-1 sm:w-full">
        <ContactLinks />
        <p className="py-6 text-xl text-center text-white">O...</p>
        <Form />
      </div>
    </section>
  );
