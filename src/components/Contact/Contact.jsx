...
const Contact = () => {
  return (
    <section id="contacto" className="container mx-auto text-center p-24 sm:p-[4.5rem] md:p-20">
      ...
      <div className="grid w-4/5 grid-cols-2 pt-10 mx-auto md:w-full sm:grid-cols-1 sm:w-full md:grid-cols-3 ">
        <ContactLinks />
        <p className="py-4 text-xl font-extrabold text-center text-white lg:hidden">O...</p>
        <Form />
      </div>
    </section>
  );
